    ...
    items: [
      {
        ...
        a: "FastBridge currently supports multiple EVM chains: Arc, Monad, MegaETH, Citrea, Arbitrum, Avalanche, Ethereum, Optimism, Base, Polygon, BNB, and HyperEVM, with more chains being added regularly. You can always check the bridge interface for the current full list.",
      },
      {
