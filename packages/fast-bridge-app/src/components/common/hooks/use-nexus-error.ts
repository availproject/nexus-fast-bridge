...
const INTERNAL_ERROR_PREFIX_REGEX = /^Internal error:\s*/i;
const COSMOS_ERROR_PREFIX_REGEX = /^COSMOS:\s*/i;
...
function sanitizeMessage(message?: string): string {
  ...
  const cleaned = message
    .replace(INTERNAL_ERROR_PREFIX_REGEX, "")
    .replace(COSMOS_ERROR_PREFIX_REGEX, "")
    .trim();
