  ...
  ({
    ...
    return (
      ...
      >
        {/* Left Indicator */}
        {isFailed ? (
          <div className="flex h-6 min-h-6 w-6 min-w-6 shrink-0 items-center justify-center rounded-full bg-red-500/10 text-red-500">
            <span className="h-2 min-h-[8px] w-2 min-w-[8px] rounded-full bg-red-500" />
          </div>
        ) : isCurrent ? (
          <div className="flex h-6 min-h-6 w-6 min-w-6 shrink-0 animate-pulse items-center justify-center rounded-full bg-chart-1/20">
            <span className="h-2.5 min-h-[10px] w-2.5 min-w-[10px] rounded-full bg-chart-1" />
          </div>
        ) : isCompleted ? (
          <div className="flex h-6 min-h-6 w-6 min-w-6 shrink-0 items-center justify-center rounded-full bg-chart-1/10">
            <span className="h-2 min-h-[8px] w-2 min-w-[8px] rounded-full bg-chart-1" />
          </div>
        ) : (
          <div className="flex h-6 min-h-6 w-6 min-w-6 shrink-0 items-center justify-center rounded-full">
            <span className="h-2 min-h-[8px] w-2 min-w-[8px] rounded-full bg-muted-foreground/50" />
          </div>
        )}
